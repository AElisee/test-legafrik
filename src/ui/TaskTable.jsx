    ...
    <div className="w-full">
      <div className="min-h-[270px]">
        ...
        <table className="w-full border rounded-2xl ">
          <thead className="bg-purple-300 border">
            <tr>
              <th className="w-1/12">ID</th>
              <th className="w-3/12">TITRE</th>
              <th className="w-3/12">DATE DE DEBUT</th>
              <th className="w-2/12">STATUT</th>
      ...
      {nPage > 1 && (
        <nav className="p-2 pt-5 flex justify-center ">
          <ul className="flex gap-2 border px-2 py-1 items-center shadow-sm bg-gray-50  rounded-2xl">
            <li className="p-2">
              <a
                href="#"
                onClick={preventPage}
